...
# def seed_data():
    ...
    # Create products
    product1 = Product(title='Product 1', price=10, length=5, width=5, height=5, description='Description of Product 1', quantity=10, img_url='https//www.image.url123', subject='A starry night')
    product2 = Product(title='Product 2', price=20, length=10, width=10, height=10, description='Description of Product 2', quantity=20, img_url='https//www.image.url456', subject='Mona Lisa')
